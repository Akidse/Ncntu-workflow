...
class Paginator
{
    ...
    public function __construct($totalItems, $itemsPerPage, $currentPage, $urlPattern = '')
    {
        ...
        if($this->currentPage > ceil($this->totalItems / $this->itemsPerPage))
        	$this->currentPage = ceil($this->totalItems / $this->itemsPerPage);
    ...
    public function toHtml()
    {
        ...
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li' . ($page['isCurrent'] ? ' class="page-item active"' : ' class="page-item"') . '><a class="page-link" href="' . $page['url'] . '">' . $page['num'] . '</a></li>';
            } else {
